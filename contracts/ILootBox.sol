...
/**
 * This is a generic animalbox contract that can be used to mint or sendrandom tokens. The configuration
 * of the contract is detailed in MyAnimalBox.sol
 */
interface IAnimalBox {
  ...
  /**
   * Indicates the Wyvern schema name for assets in this animalbox, e.g. "ERC1155"
   */
  ...
  /**
   * @dev Withdraw animalbox revenue
